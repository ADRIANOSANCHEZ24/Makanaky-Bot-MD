...
*—◉ 𝙴𝙻 𝙲𝙾𝙽𝚃𝙰𝙲𝚃𝙾 𝙳𝙴 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁 𝙴𝚂 https://instagram.com/adri2.pc*
`.trim()   
let buttonMessage= {
...
//let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;@adri2.pc 👑;;;\nFN:@adri2.pc 👑\nORG:@adri2.pc 👑\nTITLE:\nitem1.TEL;waid=51986206184:+51 986 206 184\nitem1.X-ABLabel:@fadri2.pc 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:@adri2.pc 👑\nEND:VCARD`
//await conn.sendMessage(m.chat, { contacts: { displayName: '@adri2.pc 👑', contacts: [{ vcard }] }}, {quoted: m})
